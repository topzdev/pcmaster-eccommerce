               ...
               {     !_.isEmpty(wishlist) ? (
                ...
                wishlist.map(item => (
                    <WishlistCard key={item._id} data={item} />
                            ...
                            (<ProductEmpty title={'Wishlist is empty'} description={'Click the button below to start viewing products and add it to wishlist'} link={'/products/category=components'}/>)}
